        ...
        <section className="flex flex-col items-center bg-beige">
            <div className="flex flex-col container items-center text-black text-left">
                <div className="w-full flex flex-col gap-32">
                    <h1 className="w-full text-[clamp(40px,5.56vw,80px)] leading-120 font-bold">Privacy Policy</h1>
                    <div className="w-full flex flex-col gap-32">
                        ...
                        <div className="paragraph-text flex flex-col gap-16">
                            <p>
                                This Privacy Policy explains how <span className="font-bold">Laurus Nobilis</span> collects, uses, and protects your personal data when you visit and use our website
                                <span className="font-bold">[Website URL]</span> to inquire about or book our holiday apartment located in Lovran, Croatia.
                            </p>
                            <p>
                                We are committed to protecting your privacy and processing personal data in accordance with the General Data Protection Regulation (GDPR) and applicable Croatian and EU
                ...
                <div className="w-full flex flex-col gap-32">
                    ...
                    <div className="w-full flex flex-col gap-32">
                        ...
                        <div className="paragraph-text flex flex-col gap-16">
                            <p>When you use our website or make a reservation, we may collect the following personal data:</p>
                            <ul className="list-disc pl-3.5 marker:text-10 marker:text-black">
                                <li>First and last name</li>
                                <li>Email address</li>
                                <li>Phone number</li>
                                <li>Country of residence</li>
                                <li>Booking details (check-in date, check-out date, number of guests)</li>
                                <li>Payment-related information (processed securely by our payment provider)</li>
                                <li>Any message or special request you submit during booking</li>
                            </ul>
                            <p>
                                We do <span className="font-bold">not</span> store full payment card details on our servers.
                            </p>
                        </div>
                    </div>
                </div>
                ...
                <div className="w-full flex flex-col gap-32">
                    ...
                    <div className="paragraph-text flex flex-col gap-16">
                        ...
                        <p>This data is used only for security, analytics, and website improvement.</p>
                    </div>
                </div>
                <hr className="w-full my-[48px] h-px border-0 bg-beige-darkest" />
                <div className="w-full flex flex-col gap-32">
                    ...
                    <div className="paragraph-text flex flex-col gap-16">
                        <p>
                            We use cookies and similar technologies to ensure proper website functionality and to analyze website traffic. Details are provided in our{" "}
                            <button className="font-bold underline">Cookie preferences</button> banner.
                        </p>
                    </div>
                </div>
                <hr className="w-full my-[48px] h-px border-0 bg-beige-darkest" />
                ...
                <div className="w-full flex flex-col gap-32">
                    ...
                    <div className="paragraph-text flex flex-col gap-16">
                        ...
                        <ul className="list-disc pl-3.5 marker:text-10 marker:text-black">
                            <li>
                                <span className="font-bold">Payment processors</span> (e.g. Stripe) for secure payment handling
                            </li>
                            <li>
                                <span className="font-bold">Hosting and technical service providers</span> necessary for website operation
                            </li>
                            <li>
                                <span className="font-bold">Legal or tax authorities</span>, when required by law
                            </li>
                        </ul>
                ...
                <div className="w-full flex flex-col gap-32">
                    ...
                    <div className="paragraph-text flex flex-col gap-16">
                        ...
                        <p>
                            Requests can be sent to <span className="font-bold">[Contact Email]</span>.
                        </p>
                    </div>
                </div>
                <hr className="w-full my-[48px] h-px border-0 bg-beige-darkest" />
                <div className="w-full flex flex-col gap-32">
                    ...
                    <div className="paragraph-text flex flex-col gap-16">
                        <p>We use appropriate technical and organizational measures to protect your personal data against unauthorized access, loss, or misuse.</p>
                    </div>
                </div>
                <hr className="w-full my-[48px] h-px border-0 bg-beige-darkest" />
                <div className="w-full flex flex-col gap-32">
                    ...
                    <div className="paragraph-text flex flex-col gap-16">
                        <p>Some data may be processed outside your country (e.g. by payment providers). In such cases, appropriate safeguards are applied.</p>
                    </div>
                </div>
                <hr className="w-full my-[48px] h-px border-0 bg-beige-darkest" />
                <div className="w-full flex flex-col gap-32">
