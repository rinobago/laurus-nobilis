    ...
    return (
        <div
            ...
            <div className="flex flex-col gap-24 items-start justify-center px-24 py-16 w-full text-black">
                <p className="font-semibold leading-150 text-16 text-left pb-4 border-b border-beige-darkest w-full">
                    Laurus Nobilis
                </p>
                ...
                <div className="flex flex-col justify-start items-center gap-8 w-full">
                    ...
                    <div className="flex justify-between items-start w-full leading-150 text-14 text-left ">
                        <div className="flex flex-col justify-start items-center">
                            <p className="w-full">
                                {nights} {t("Nights")} x € {formatDecimal(priceNight)}
                            </p>
                            <p className="w-full">{t("CleaningFee")}</p>
                        </div>
                        <div className="flex flex-col justify-start items-center">
                ...
                <hr className="w-full h-px border-0 bg-beige-darkest" />
                <div className="flex flex-col justify-start items-center gap-8 w-full">
                    <p className="text-14 text-left w-full leading-150 font-medium">{t("Total")}</p>
                ...
                <div className="flex flex-col justify-center items-center gap-4 w-full">
                    ...
                    <p className="w-full text-center text-10 leading-150 ">{t("ReviewPayment")}</p>
                </div>
            </div>
        </div>
    );
