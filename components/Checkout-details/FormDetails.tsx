        ...
        <form action="post" id="details-form" onSubmit={handleSubmit} className="flex flex-col gap-24 w-full md:w-101 items-start justify-center">
            <div className="flex gap-[clamp(8px,2.08vw,16px)] justify-center items-center w-full">
                <div className="w-full flex flex-col justify-center items-start gap-8">
                    ...
                    <input type="text" name="" id="" className="w-full bg-beige-dark border border-beige-darker px-3.5 py-2.5 rounded-md text-black text-16 leading-150" />
                </div>
                <div className="w-full flex flex-col justify-center items-start gap-8">
                    <label htmlFor="" className="formLabel">
                        Last name
            ...
            <div className="w-full flex flex-col justify-center items-start gap-8">
                ...
                <div className="relative flex items-center justify-center">
                    <select id="guests" className="appearance-none w-17 flex bg-beige-dark border border-beige-darker px-3.5 py-2.5 rounded-md text-black text-16 leading-150">
