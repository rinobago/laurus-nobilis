...
export default function FilterDropdown({ open, onClose }: { open: boolean; onClose: () => void }) {
    ...
    return (
        <div className="overflow-hidden absolute top-full md:left-1/2 md:-translate-x-1/2 right-0 mt-[8px] w-26.75 h-42 bg-beige-dark border border-beige-darker rounded-md flex flex-col">
            <button
                onClick={onClose}
